...
void main() {
  group('ResolveNullAssertStaticAnalysisErrors', () {
    final resolver = ResolveNullAssertStaticAnalysisErrorsForStrings();
...
""";
      // print(
      //   '${resolver(fileContent) == fileContent}\n"${resolver(fileContent).blue}"',
      // );
      expect(resolver(fileContent), expected);
    });
  });
}
