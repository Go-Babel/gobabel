...
void main() {
  group('RemoveAdjacentStringLiteralConcatenationUsecase', () {
    late RemoveAdjacentStringLiteralConcatenationUsecase usecase;

    setUp(() {
      usecase = RemoveAdjacentStringLiteralConcatenationUsecase();
    });
    ...
    group('Basic string concatenation', () {
      test('should combine two adjacent double-quoted strings', () {
        ...
        final result = usecase.runForSingleFileContent(input);
