...
_$TranslationPayloadInfoImpl _$$TranslationPayloadInfoImplFromJson(
    ...
    _$TranslationPayloadInfoImpl(
      hardcodedStringToKeyCache:
          Map<String, String>.from(json['hardcodedStringToKeyCache'] as Map),
      keyToDeclaration:
          Map<String, String>.from(json['keyToDeclaration'] as Map),
      keyToImplementation:
          Map<String, String>.from(json['keyToImplementation'] as Map),
      keyToContextsPaths:
          (json['keyToContextsPaths'] as Map<String, dynamic>).map(
        (k, e) =>
            MapEntry(k, (e as List<dynamic>).map((e) => e as String).toSet()),
      ),
      referenceMap: (json['referenceMap'] as List<dynamic>)
...
Map<String, dynamic> _$$TranslationPayloadInfoImplToJson(
    ...
    <String, dynamic>{
      ...
      'keyToContextsPaths':
          instance.keyToContextsPaths.map((k, e) => MapEntry(k, e.toList())),
...
Map<String, dynamic> _$$TranslatablesImplToJson(_$TranslatablesImpl instance) =>
    <String, dynamic>{
      'locale':
