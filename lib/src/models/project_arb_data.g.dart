...
_$ArbDataStateWithDataImpl _$$ArbDataStateWithDataImplFromJson(
  ...
  mainLocale: const BabelSupportedLocalesJsonConverter().fromJson(
    json['mainLocale'] as Map<String, dynamic>,
  ),
  preMadeTranslationArb:
      (json['preMadeTranslationArb'] as List<dynamic>)
...
_$ArbDataStateNoneDataImpl _$$ArbDataStateNoneDataImplFromJson(
  Map<String, dynamic> json,
) => _$ArbDataStateNoneDataImpl($type: json['runtimeType'] as String?);
...
Map<String, dynamic> _$$ArbFileDataImplToJson(
  _$ArbFileDataImpl instance,
) => <String, dynamic>{
