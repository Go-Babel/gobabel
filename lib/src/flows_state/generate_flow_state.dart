...
abstract class GenerateFlowState
  ...
  int get stepCount => map(
    ...
    commitedAllChangesOfCodebase: (_) => 40,
    getBabelChangesCommit: (_) => 41,
    sincronizedBabelCommitWithApi: (_) => 42,
  );
  ...
  @override
  bool get shouldReset => stepCount < 39;
}
